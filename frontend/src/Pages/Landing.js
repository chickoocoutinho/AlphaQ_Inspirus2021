      ...
      <div style={{ position: "absolute", zIndex: 10, marginTop: "40rem" }}>
        <Row>
          <Col span={12}>
            ...
            >
              We Make In Easier and Hassle Free for you to integrate the courses
              you registered for on Google Classroom
            </h1>
            <p
              style={{
                textAlign: "center",
      ...
      <div style={{ position: "absolute", zIndex: 10, marginTop: "65rem" }}>
        <Row>
          ...
          <Col span={12}>
            ...
            >
              Get all the classes you’ve registered for just by signing into our
              platform using Google.
            </p>
          </Col>
        </Row>
      </div>
      <div style={{ position: "absolute", zIndex: 10, marginTop: "90rem" }}>
        <Row>
          <Col span={12}>
            ...
            >
              The AI based search checks for all notes across the platform which
              are closely related to the search query.{" "}
            </p>
          </Col>
          <Col span={12}>
            <Player
